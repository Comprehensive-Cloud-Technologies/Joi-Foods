        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="page-title-custom mb-1">Departments - <?php echo $company->name; ?></h4>
                    ...
                    <a href="<?php echo base_url('client/departments/add/' . $company->id) ?>" class="btn btn-primary">
                    ...
                    <div class="stat-card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="flex-grow-1">
                                ...
                                <?php $active_count = count(array_filter($departments, function($d) { return $d->is_active == 1; })); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <a href="<?php echo base_url('client/departments/edit/' . $department->id); ?>" class="btn btn-soft-warning action-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
