        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="page-title-custom mb-1">Documents - <?php echo $store->name; ?></h4>
                    ...
                    <a href="<?php echo base_url('client/stores/add_document/' . $store->id) ?>" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <a href="<?php echo base_url('client/stores/download_document/' . $doc->id); ?>" class="btn btn-soft-primary action-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Download">
