    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('client/stores/view/' . $store->id); ?>"><?php echo $store->name; ?></a></li>
                            <li class="breadcrumb-item"><a href="<?php echo base_url('client/stores/documents/' . $store->id); ?>">Documents</a></li>
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="upload_document" action="<?php echo base_url('client/stores/store_document') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="label" name="label" placeholder="e.g. FSSAI Certificate, Trade License, GST Certificate">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="<?php echo base_url('client/stores/documents/' . $store->id); ?>" class="btn btn-light">Cancel</a>
            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Store</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-muted">
                            <p><i class="uil uil-check-circle text-success me-1"></i> Label helps identify the document (e.g. "FSSAI Certificate").</p>
