<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <h4 class="page-title-custom">Company Billing Report</h4>
                <p class="text-muted mb-0">Company-wise billing and contribution breakdown</p>
            </div>
        </div>
                    ...
                    <div class="stat-card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="stat-value" id="summary_companies">0</h3>
                            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card dashboard-card">
                    <div class="stat-card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="flex-grow-1">
                                <p class="stat-label">Company Share</p>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card dashboard-card">
                    <div class="stat-card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="flex-grow-1">
                                <p class="stat-label">Employee Share</p>
                ...
                <div class="card list-card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="billing_table" class="table table-hover" style="width: 100%;">
