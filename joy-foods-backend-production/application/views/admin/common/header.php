        ...
        <header id="page-topbar">
            <div class="navbar-header">
                ...
                <div class="d-flex">
                    ...
                    $admin_full_name = !empty($admin_details) ? $admin_details->full_name : 'Admin';
                    ?>
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="https://ui-avatars.com/api/?bold=true&background=0f523b&name=<?php echo $admin_full_name ?>&rounded=true&color=fff" alt="Header Avatar">
                            <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-15"><?php echo $admin_full_name ?></span>
                            <i class="uil-angle-down d-none d-xl-inline-block font-size-15"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <a class="dropdown-item" href="<?php echo base_url('admin_root/profile/change_password') ?>"><i class="uil uil-lock-alt font-size-18 align-middle text-muted me-1"></i> <span class="align-middle">Change Password</span></a>
