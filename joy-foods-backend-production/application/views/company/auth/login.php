...
<head>
    ...
    <style>
        ...
        .login-card::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #2ab57d, #5156be, #f1b44c);
        }
        ...
        .form-control-enhanced:focus {
            border-color: #2ab57d;
            box-shadow: 0 0 0 0.2rem rgba(42, 181, 125, 0.25);
        ...
        /* Enhanced button */
        .btn-login {
            background: linear-gradient(135deg, #2ab57d, #5156be);
            border: none;
            border-radius: 12px;
            padding: 0.8rem 2rem;
            font-weight: 600;
        ...
        .btn-login:hover {
            transform: translateY(-2px);
            box-shadow: 0 10px 20px rgba(42, 181, 125, 0.3);
        }
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <a href="<?php echo base_url('company'); ?>" class="mb-5 d-block auth-logo">
                    ...
                    <div class="card login-card">
                        <div class="card-body p-4">
                            <div class="text-center mt-2 welcome-text">
                                <h5 class="text-success mb-3" style="font-weight: 700; font-size: 1.5rem;">Company Portal</h5>
                                <p class="text-muted mb-0">Sign in to access your company dashboard.</p>
                            </div>

                            <div class="p-2 mt-4 login-form">
                                <form action="<?php echo base_url('company/common/check_login') ?>" id="login_form" name="login_form">
                                    <div class="input-group-custom form-group">
                                        ...
                                        <label class="form-label-custom" for="username">Email or Phone</label>
                                    </div>
                                    ...
                                    <div class="mt-4 text-center">
                                        <button class="btn btn-success btn-login w-100 waves-effect waves-light" type="submit" id="submit_button">
