<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <h4 class="page-title-custom">QSR Report</h4>
                <p class="text-muted mb-0">Quick Service Restaurant order reports</p>
            </div>
        </div>
                ...
                <div class="card list-card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="qsr_table" class="table table-hover" style="width: 100%;">
